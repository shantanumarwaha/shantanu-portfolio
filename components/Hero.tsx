...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="animate-fade-in-up glow-card relative z-10 flex w-full max-w-2xl flex-col items-start rounded-3xl border border-white/[0.14] bg-gradient-to-b from-white/[0.07] to-white/[0.02] px-8 py-14 text-left shadow-2xl backdrop-blur-md sm:px-10 sm:py-16">
