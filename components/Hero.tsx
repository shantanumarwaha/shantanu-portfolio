...
export default function Hero() {
  return (
    <section
      id="top"
      className="sticky top-0 z-0 flex h-screen min-h-screen items-center overflow-hidden bg-background"
    >
      <JourneyGlobe />

      <div className="relative z-10 flex w-full items-center px-6 md:w-1/2 md:px-16">
        <div className="animate-fade-in-up glow-card flex w-full max-w-xl flex-col items-start rounded-3xl border border-white/[0.14] bg-gradient-to-b from-white/[0.07] to-white/[0.02] px-8 py-14 text-left shadow-2xl backdrop-blur-md sm:px-10 sm:py-16">
          <h1 className="font-display text-4xl font-normal whitespace-nowrap text-foreground sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            {profile.name}
          </h1>
